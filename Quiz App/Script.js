...
const timerDurationInSeconds = 601; // 5 minutes

// Get the timer display element
const timerDisplay = document.getElementById('timer');
timerDisplay.innerHTML = 'Timer: 00:00'; // Add timer name

// Calculate the end time
const endTime = new Date().getTime() + (timerDurationInSeconds * 1000);
...
function updateTimer() {
    ...
    if (remainingTime <= 0) {
        ...
        // Stop the exam and show the results
